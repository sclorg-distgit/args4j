...
%pom_remove_plugin :maven-shade-plugin %{pkg_name}-tools
...
%changelog
* Wed Jul 20 2016 Mat Booth <mat.booth@redhat.com> - 2.32-3.2
- Don't use koshuke parent pom

* Wed Jul 20 2016 Mat Booth <mat.booth@redhat.com> - 2.32-3.1
